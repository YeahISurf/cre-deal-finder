...
if (!API_KEY) {
  ...
  console.error('Usage: node test-models-improved.js YOUR_API_KEY');
  process.exit(1);
}
...
{
  "seller_motivation_score": [score from 1-10],
  "seller_motivation_explanation": "[your explanation]",
  "seller_motivation_keywords": ["keyword1", "keyword2", ...],
  
  "transaction_complexity_score": [score from 1-10],
  "transaction_complexity_explanation": "[your explanation]",
  "transaction_complexity_keywords": ["keyword1", "keyword2", ...],
  
  "property_characteristics_score": [score from 1-10],
  "property_characteristics_explanation": "[your explanation]",
  "property_characteristics_keywords": ["keyword1", "keyword2", ...],
  
  "total_score": [weighted average of the three scores]
}
